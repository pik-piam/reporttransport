...
R package **reporttransport**, version **0.2.0**
...
Hoppe J (2024). _reporttransport: Reporting package for edgeTransport_. R package version 0.2.0, <https://github.com/pik-piam/reporttransport>.
