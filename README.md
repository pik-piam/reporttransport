...
R package **reporttransport**, version **1.3.0**
...
Hoppe J, Muessel J, Hagen A (2026). "reporttransport: Reporting package for edgeTransport." Version: 1.3.0, <https://github.com/pik-piam/reporttransport>.
