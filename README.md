...
R package **reporttransport**, version **0.0.7**
...
Hoppe J (2024). _reporttransport: Reporting package for edgeTransport_. R package version 0.0.7, <https://github.com/pik-piam/reporttransport>.
