...
### Bunkers
```{r Bunkers}
# tot <- "FE|Transport|Bunkers" #this tot does not exist
items <- c(
  "FE|Transport|Bunkers|Freight|Liquids",
  "FE|Transport|Bunkers|Pass|Liquids"
  )
showAreaAndBarPlots(data, items, orderVars = "user")
showAreaAndBarPlots(data, items, fill = TRUE, orderVars = "user")
walk(items, showLinePlots, data = data)
```
...
### Passenger International Aviation

```{r Passenger International Aviation}
...
### Transport total w/o bunkers - modes
```{r}
tot <- "FE|Transport"
items <- c(
...
showAreaAndBarPlots(data, items[2:8], tot_wobunk, orderVars = "user")
showAreaAndBarPlots(data, items, tot_wbunk, fill = TRUE, orderVars = "user")
showAreaAndBarPlots(data, items[2:8], tot_wobunk, fill = TRUE, orderVars = "user")
showLinePlots(data, tot_wbunk)
walk(c("FE|Transport|Pass|Aviation", items[1:2], "FE|Transport|Pass|Rail", items[3:5], "FE|Transport|Pass|Road|LDV", items[6:8]), showLinePlots, data = data)
```
