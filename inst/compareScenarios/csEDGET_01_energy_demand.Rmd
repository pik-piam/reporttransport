...
items <- c("FE|Transport with bunkers|Electricity",
...
```{r}
tot <- "FE|Transport"
items <- c("FE|Transport|Electricity",
...
items <- c("FE|Transport|Road|Electricity",
...
items <- c("FE|Transport|Pass with bunkers|Electricity",
...
items <- c("FE|Transport|Pass|Electricity",
...
items <- c("FE|Transport|Pass|Road|LDV|Four Wheelers|Electricity",
...
items <- c("FE|Transport|Pass|Road|LDV|Two Wheelers|Electricity",
...
items <- c("FE|Transport|Pass|Road|Bus|Electricity",
...
items <- c("FE|Transport|Pass|Rail|non-HSR|Electricity",
...
items <- c("FE|Transport|Freight with bunkers|Electricity",
...
items <- c("FE|Transport|Freight|Electricity",
...
items <- c("FE|Transport|Freight|Road|Electricity",
...
items <- c("FE|Transport|Freight|Rail|Electricity",
...
items <- c("FE|Transport|Pass|Road|LDV|Liquids|Fossil",
...
items <- c("FE|Transport|Pass|Road|Bus|Liquids|Fossil",
...
items <- c("FE|Transport|Pass|Rail|Liquids|Fossil",
...
items <- c("FE|Transport|Pass|Domestic Aviation|Liquids|Fossil",
...
items <- c("FE|Transport|Bunkers|Pass|International Aviation|Liquids|Fossil",
...
items <- c("FE|Transport|Freight|Road|Liquids|Fossil",
...
items <- c("FE|Transport|Freight|Rail|Liquids|Fossil",
...
items <- c("FE|Transport|Freight|Domestic Shipping|Liquids|Fossil",
...
items <- c("FE|Transport|Bunkers|Freight|International Shipping|Liquids|Fossil",
...
### Passenger
```{r}
totWithBunkersers <- "FE|Transport|Pass with bunkers"
totWithoutBunkers <- "FE|Transport|Pass"
items <- c("FE|Transport|Bunkers|Pass|International Aviation",
...
showAreaAndBarPlots(data, items[2:7], totWithoutBunkers, orderVars = "user")
showAreaAndBarPlots(data, items, totWithBunkers, fill = TRUE, orderVars = "user")
showAreaAndBarPlots(data, items[2:7], totWithoutBunkers, fill = TRUE, orderVars = "user")
...
### Freight
```{r}
totWithBunkersers <- "FE|Transport|Freight with bunkers"
totWithoutBunkers <- "FE|Transport|Freight"
items <- c("FE|Transport|Bunkers|Freight|International Shipping",
           "FE|Transport|Freight|Domestic Shipping",
           "FE|Transport|Freight|Rail",
           "FE|Transport|Freight|Road")
showAreaAndBarPlots(data, items, totWithBunkersers, orderVars = "user")
showAreaAndBarPlots(data, items[2:4], totWithoutBunkers, orderVars = "user")
showAreaAndBarPlots(data, items, totWithBunkersers, fill = TRUE, orderVars = "user")
