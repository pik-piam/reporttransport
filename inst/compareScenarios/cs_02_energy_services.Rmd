...
showMultiLinePlotsByVariable(data, items[c(1:7,11)], "GDP|PPP pCap", nrowNum = 2, mainReg = "")
showMultiLinePlotsByVariable(data, items[c(8:15)], "GDP|PPP pCap", nrowNum = 2, mainReg = "")
showMultiLinePlotsByVariable(data, items[c(16,17)], "GDP|PPP pCap", nrowNum = 2, mainReg = "")
...
#### LDV 3-Wheelers
```{r}
tot <- c("ES|Transport|Pass|Road|LDV|Three Wheelers")
items <- c(
     "ES|Transport|Pass|Road|LDV|Three Wheelers|BEV",
     "ES|Transport|Pass|Road|LDV|Three Wheelers|Liquids"
  )
...
#### LDV 2-Wheelers
```{r}
tot <- c("ES|Transport|Pass|Road|LDV|Two Wheelers")
items <- c(
...
#### Without bunkers
```{r}
totWoBunk <- "ES|Transport|Freight"
items <- c(
...
showMultiLinePlotsByVariable(data, items, "GDP|PPP pCap", nrowNum = 2, mainReg = "")
walk(items, showLinePlotsByVariable, data = data, xVar = "GDP|PPP pCap")
```
