...
items <- c("Stock|Transport|LDV|Compact Car",
...
items <- c("Sales|Transport|LDV|Compact Car",
...
items <- c("Stock|Transport|LDV|Subcompact Car|BEV",
...
items <- c("Sales|Transport|LDV|Subcompact Car|BEV",
...
items <- c("Stock|Transport|LDV|Large Car and SUV|BEV",
...
items <- c("Sales|Transport|LDV|Large Car and SUV|BEV",
...
items <- c("Stock|Transport|Bus|Electric",
...
items <- c("Stock|Transport|Truck|truck (0-3_5t)",
...
items <- c("Sales|Transport|Truck|truck (0-3_5t)",
...
items <- c("Stock|Transport|Truck|truck (0-3_5t)|Electric",
...
items <- c("Sales|Transport|Truck|truck (0-3_5t)|Electric",
...
items <- c("Stock|Transport|Truck|Truck (40t)|Electric",
...
items <- c("Sales|Transport|Truck|Truck (40t)|Electric",
