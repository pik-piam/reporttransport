...
# ---- Energy intensity ----
  # 1: Energy intensity reported by EDGE-T to REMIND in[trn pkm/Twa or trn tkm/Twa]
  ...
  # 2:pm_fe2es Energy intensity of transport nodes parameter from the last REMIND iteration -> REMIND_val
